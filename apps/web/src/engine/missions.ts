import type { BattleSetup, Position } from '@warhammer-simulator/core/types/battle';
import { CHAPTER_APPROVED_MISSION_POOL, type TournamentMissionSpec } from '@warhammer-simulator/core/data/missions';
import { DEFAULT_OBJECTIVE_MARKERS, OBJECTIVE_MARKER_SETS } from '@warhammer-simulator/core/data/objectiveMarkers';
