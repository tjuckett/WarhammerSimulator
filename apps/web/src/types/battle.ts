...
import type { ObjectiveControlProfile } from '@warhammer-simulator/core/engine/objectiveGeometry';
import type { RulesetMetadata } from '@warhammer-simulator/core/engine/rulesEngine';
