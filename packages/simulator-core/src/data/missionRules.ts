...
const PURGE_THE_FOE_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Purge the Foe card. Consecration marker tracking is still required for consecrated-objective clauses.',
    scoring: [
      {
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Purge the Foe card. Destroyed-unit tracking is still required for kill clauses.',
    scoring: [
      {
        id: 'enemy-destroyed',
        timing: 'end-turn',
      ...
      },
      {
        ...
        notes: 'Requires destroyed-unit counts for the current and previous turn.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Purge the Foe card. Destroyed-unit and start-of-turn objective tracking are still required for two clauses.',
    scoring: [
      {
        id: 'enemy-destroyed',
        timing: 'end-turn',
...
const PRIORITY_ASSETS_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Priority Assets card. Vanguard Operation action and destroyed-unit tracking are still required for two clauses.',
    scoring: [
      {
...
const DISRUPTION_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Disruption card. Decoy action and operation marker tracking are still required for decoy clauses.',
    scoring: [
      {
        id: 'decoy-objectives',
        timing: 'end-turn',
