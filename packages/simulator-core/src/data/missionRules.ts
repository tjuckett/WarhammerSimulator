...
export interface SecondaryMissionScoringClause {
  ...
  notes?: string;
  maxVp?: number;
  relationship?: 'exclusive' | 'cumulative' | 'or';
}
...
const PURGE_THE_FOE_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  {
    ...
    notes: 'Scoring text audited against the current GDM Purge the Foe card. A friendly unit that destroyed an enemy can consecrate one non-home objective in range at turn end; persistent markers drive the exclusive tiers and enemy-home bonus.',
    scoring: [
      {
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Purge the Foe card. Start-of-turn condemned-unit selection and battlefield-exit scoring are implemented.',
    scoring: [
      {
...
const RECONNAISSANCE_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Reconnaissance card. Immediate Surveil actions, marked-objective protection, move-end enemy marker removal, and no-enemy-marker scoring are implemented.',
    scoring: [
      {
        ...
        notes: 'Uses immediate Surveil action events and operation markers associated with objectives.',
      },
      {
        id: 'round-2-plus-one-non-home-objective',
        timing: 'end-command-phase',
      ...
      },
      {
        ...
        notes: 'Uses persistent operation markers and automatic removal after friendly units end moves within objective range.',
      },
    ],
  },
  {
...
const PRIORITY_ASSETS_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Priority Assets card. Sensor Sweep, start-of-turn objective proximity destruction, and isolated opponent marker scoring are implemented.',
    scoring: [
      {
        id: 'sensor-sweep',
        timing: 'end-turn',
        ...
        notes: 'Resolves from the once-per-turn Sensor Sweep action completed while its unit controls a central objective.',
      },
      {
      ...
      },
      {
        ...
        notes: 'Uses operation marker positions and terrain-area unit membership.',
      },
      {
        id: 'round-2-plus-one-non-home-objective',
        timing: 'end-command-phase',
...
const DISRUPTION_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Disruption card. Booby Trap actions, trapped terrain markers, destroyed-unit tracking, and isolated-marker scoring are implemented.',
    scoring: [
      {
        id: 'trapped-terrain',
        timing: 'end-turn',
        ...
        vp: 2,
        bonusVp: 3,
        sourceText: 'Any battle round, end of your turn: For each terrain area trapped this turn, 2VP; for each of those terrain areas that is an objective, +3VP.',
      },
      {
  ...
  },
  {
    ...
    notes: 'Scoring text audited against the current GDM Disruption card. Central and expansion objective roles are represented explicitly.',
    scoring: [
      {
        ...
        condition: 'destroyed-enemy-this-turn',
        vp: 2,
        sourceText: 'Any battle round, end of your turn: For each enemy unit destroyed this turn. 2VP.',
      },
      {
        id: 'round-2-plus-one-non-home-objective',
        timing: 'end-command-phase',
      ...
      },
      {
        ...
        vp: 3,
        sourceText: 'Second battle round onwards, end of your turn: You control one or more central objectives and one or more expansion objectives. 3VP.',
      },
      {
        id: 'round-5-one-non-home-objective',
        timing: 'end-turn',
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Disruption card. Sensor Sweep and enemy operation marker state are implemented.',
    scoring: [
      {
        id: 'sensor-sweep',
        timing: 'end-turn',
      ...
      },
      {
        ...
        notes: 'Uses persistent operation marker state.',
      },
    ],
  },
  {
...
export const ELEVENTH_SECONDARY_MISSION_RULES: SecondaryMissionRuleSpec[] = [
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Defender secondary card. Fixed and tactical end-of-turn scoring are wired from preserved Character and Wounds facts, including the fixed cumulative Wounds bonus and tactical OR condition.',
    scoring: [
      {
        id: 'fixed-character-destroyed',
        mode: 'fixed',
        timing: 'End of a turn',
        vp: 3,
        sourceText: 'For each enemy Character model destroyed this turn. 3VP.',
        notes: 'Automatically scored from preserved per-model Character destruction events at the end of each turn.',
      },
      {
        id: 'fixed-character-wounds-four-plus-bonus',
        mode: 'fixed',
        timing: 'End of a turn',
        vp: 1,
        sourceText: 'For each of those models with a Wounds characteristic of 4 or more. 1VP.',
        relationship: 'cumulative',
        notes: 'Cumulative with the 3VP fixed Character-destruction clause.',
      },
      {
        id: 'tactical-character-destroyed-or-all-characters-destroyed',
        mode: 'tactical',
        timing: "End of either player's turn",
        vp: 5,
        sourceText: 'One or more enemy Character models were destroyed this turn, or all enemy Character models have been destroyed during the battle. 5VP.',
        relationship: 'or',
        notes: 'The two alternatives form one OR condition and can award only 5VP total at an opportunity.',
      },
    ],
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Defender secondary card. Deadline scoring awards only the highest exclusive tier; territory-dependent scoring fails closed where a layout has no explicit territory roles.',
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 secondary card. Fixed and tactical end-of-turn scoring are wired from preserved per-model Wounds facts.',
    ...
    scoring: [
      {
        ...
        notes: 'Automatically scored for each qualifying per-model destruction event at the end of the turn.',
      },
      {
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 secondary card. Exclusive end-of-owner-turn tiers use footprint-aware battlefield-centre proximity and friendly eligibility filters.',
    scoring: [
      {
      ...
      },
      {
        ...
        relationship: 'exclusive',
        notes: 'Exclusive higher tier; automatically scored using footprint-aware centre proximity and Aircraft/Battle-shock exclusions for friendly units.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 secondary card. Deadline scoring uses a 3VP home-control clause plus a cumulative 2VP enemy-free deployment-zone bonus.',
    ...
    scoring: [
      {
        ...
        mode: 'tactical',
        timing: "Second battle round onwards, end of your opponent's turn or the end of the fifth battle round, whichever comes first",
        vp: 3,
      ...
      {
        id: 'no-enemy-deployment-zone-bonus',
        mode: 'tactical',
        timing: "Second battle round onwards, end of your opponent's turn or the end of the fifth battle round, whichever comes first",
        vp: 2,
        sourceText: 'No enemy units are within your deployment zone. 2VP.',
        relationship: 'cumulative',
        notes: 'Cumulative with the home-control clause; footprint-aware deployment-zone checks fail closed when setup geometry is unknown.',
      },
    ],
  },
  {
