...
const DISRUPTION_PRIMARY_MISSIONS: PrimaryMissionRuleSpec[] = [
  ...
  },
  {
    ...
    notes: 'Scoring text transcribed from GDM 2026 Disruption card. Central and player expansion objective roles are represented explicitly.',
    scoring: [
      {
...
export const ELEVENTH_SECONDARY_MISSION_RULES: SecondaryMissionRuleSpec[] = [
  {
    ...
    scoring: [
      ...
      },
      {
        ...
        timing: 'End of a turn',
        vp: 5,
        sourceText: 'For each enemy unit with a Starting Strength of 13 or more that is destroyed this turn. 5VP, max 5VP.',
        maxVp: 5,
        notes: 'Automatically scored from destroyed-unit starting-strength events at the end of each turn.',
      },
    ],
  ...
  },
  {
    ...
    scoring: [
      ...
      },
      {
        ...
        timing: 'End of a turn',
        vp: 5,
        sourceText: 'For each enemy model with a Wounds characteristic of 10 or more destroyed this turn. 5VP, max 5VP.',
        maxVp: 5,
