...
- [x] Cleanse, Plunder, and the currently sourced secondary-mission state paths are implemented and covered by simulator-core tests; newly sourced mission actions remain an explicit follow-up.
