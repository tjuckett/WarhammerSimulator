...
- [ ] Keep phase logic structured as ordered phase steps, not one large phase function.
  - Progress: unit/phase stepping is already exposed, and the atomic simulator now delegates Command phase setup/resolution to a named core phase helper; Movement, Shooting, Charge, and Fight extraction remains.
