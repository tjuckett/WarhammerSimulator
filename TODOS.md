...
- [ ] Re-audit shared 10th-compatible movement, shooting, charge, fight, Battle-shock, objective control, reserves, transports, terrain, aircraft, and vertical rules against the final full 11th wording.
  ...
  - Progress: charge resolution now supports serialized multi-target declarations, requires engagement with every declared target, and fails closed for undeclared enemies; the legal-action generator still emits single-target suggestions.
