...
- [ ] Re-audit shared 10th-compatible movement, shooting, charge, fight, Battle-shock, objective control, reserves, transports, terrain, aircraft, and vertical rules against the final full 11th wording.
  ...
  - Progress: final Core 08.03 now retests already Battle-shocked units even after they recover above half-strength; a unit clears Battle-shock only when that single command-step roll succeeds.
