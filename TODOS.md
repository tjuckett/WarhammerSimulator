...
- [ ] Re-audit shared 10th-compatible movement, shooting, charge, fight, Battle-shock, objective control, reserves, transports, terrain, aircraft, and vertical rules against the final full 11th wording.
  ...
  - Progress: Rapid Ingress availability and direct use are now restricted to the opponent's Movement/Reinforcements step, matching the modeled end-of-Movement placement flow; impossible-placement and large-model setup coverage remains open.
