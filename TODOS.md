...
- [ ] Keep phase logic structured as ordered phase steps, not one large phase function.
  - Progress: unit/phase stepping is already exposed, and the atomic simulator now delegates Command, Movement, and Shooting phase setup/resolution to named core phase helpers; Charge and Fight extraction remains.
