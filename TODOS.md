...
- [x] Implement exact scoring for all 25 unique 11th primary missions once source text is available. Territory-dependent clauses fail closed when a layout has not yet supplied its explicit region polygons.
- [x] Add tests for every implemented 11th primary mission scoring rule.
